...
Widget bar(GlobalKey<ScaffoldState> key,
    {Function onTap,
  ...
  final Widget title = new AutoSizeText(text,
      minFontSize: 12,
      maxLines: 1,
  ...
  final Widget tab = controller == null
      ...
      : TabBar(
          ...
          tabs: <Widget>[
            new Tab(text: tabtitle),
            new Tab(text: "My Task"),
            if (text == "Work Order" && isSupervisor)
              new Tab(text: "MR Approval")
          ],
        );
  ...
  return AppBar(
    ...
    leading: new IconButton(
        icon: new Opacity(
          ...
          child: new Image.asset("assets/icon_trans.png", width: 30.0),
        ),
        color: Colors.black,
        onPressed: () {
