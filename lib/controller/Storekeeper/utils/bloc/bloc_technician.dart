...
class BlocTechnician extends Bloc {
  ...
  BlocTechnician({this.type = ScreenType.forTechnician})
      : items = List.generate(
            1,
            (index) => Item(
                group: "Group A",
...
class BlocTechnicianDetails extends Bloc {
  ...
  final BehaviorSubject<List<String>> _controllerGroups =
      BehaviorSubject<List<String>>();
  final BehaviorSubject<List<String>> _controllerSubGroups =
      BehaviorSubject<List<String>>();
  final BehaviorSubject<List<String>> _controllerItems =
      BehaviorSubject<List<String>>();
  ...
  Stream<bool> get verifySubmittion =>
      CombineLatestStream.combine3(group, sub, item, (a, b, c) => true);
