...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(ComplaintDGroupStore.serializer)
      ..add(ComplaintDImage.serializer)
      ..add(ComplaintDPart.serializer)
      ..add(ComplaintDStore.serializer)
      ..add(ComplaintDStoreType.serializer)
      ..add(ComplaintDType.serializer)
      ..add(ComplaintImage.serializer)
      ..add(ComplaintMaterial.serializer)
      ..add(ComplaintMaterialGrouped.serializer)
      ..add(ComplaintMaterialImage.serializer)
      ..add(ComplaintResponse.serializer)
      ..add(Dot.serializer)
      ..add(EventAtt.serializer)
      ..add(EventDetail.serializer)
      ..add(Form.serializer)
      ..add(FormAItem.serializer)
      ..add(FormBItem.serializer)
      ..add(FormCItem.serializer)
      ..add(FormDItem.serializer)
      ..add(FormEItem.serializer)
      ..add(FormFItem.serializer)
      ..add(FormGItem.serializer)
      ..add(FormHItem.serializer)
      ..add(GamificationInfo.serializer)
      ..add(Material.serializer)
      ..add(MaterialStorePart.serializer)
      ..add(Meter.serializer)
      ..add(MonitorDetail.serializer)
      ..add(MonitorHistory.serializer)
      ..add(MonitorTask.serializer)
      ..add(Reading.serializer)
      ..add(RequestTask.serializer)
      ..add(ResponseValue.serializer)
      ..add(Task.serializer)
      ..add(TechnicianAssign.serializer)
      ..add(TechnicianDetails.serializer)
      ..add(TechnicianImageRepair.serializer)
      ..add(TechnicianTask.serializer)
